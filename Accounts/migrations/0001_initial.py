    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_image', models.ImageField(blank=True, upload_to=Accounts.models.project_directory_path, verbose_name='Аватар')),
                ('main_image', models.ImageField(blank=True, upload_to=Accounts.models.project_directory_path, verbose_name='Основное фото')),
            ],
            options={
                'verbose_name': 'Проект',
        ...
        migrations.AddField(
            model_name='project',
            name='spec_proj',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='Accounts.specproject', verbose_name='Специализация'),
        ),
        migrations.AddField(
            model_name='project',
            name='type',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='Accounts.typeproject', verbose_name='Тип преокта'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
